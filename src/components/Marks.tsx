...
const Marks = ({ designChecked, developmentChecked, researchChecked, handleDesignChange, handleDevelopmentChange, handleResearchChange}: Props) => {
    return (
        <>
            <h3>Отметки</h3>
            <form>
                ...
                <br />
                <label>
                <input type="checkbox" name="marks" checked={developmentChecked} onChange={handleDevelopmentChange} />
                Development
                </label>
                <br />
                <label>
